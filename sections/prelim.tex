...
%  $\limbs$' &  \\
 ...
 $\alpha_w$ & Norm bound for ring elements used as coefficients for homomorphic addition of our HVC\eprint{s} or KOTS.\\
 $\alpha_H$ & Norm bound for ring elements used as randomized in the construction of each individual KOTS signature.\\
  $\errorbound$ & Error bound. Homomorphic addition may fail with at most this probability for our HVC\eprint{s} or KOTS.\\
 %
