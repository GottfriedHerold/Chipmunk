...
We benchmark the cost of encoding mechanism. On a single thread, the encoding algorithm takes $7.3 us$ to convert a single node into its encoded form; and the decoding algorithm takes $6.6 us$ for the reverse direction.
