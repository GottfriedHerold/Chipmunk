...
On a single thread, the encoding algorithm takes $7.3 \mu\mathrm{s}$ to convert a single node into its encoded form and the decoding algorithm takes $6.6 \mu\mathrm{s}$ for the reverse direction.
