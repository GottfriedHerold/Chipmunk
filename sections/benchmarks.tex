...
\begin{table}\centering
  \begin{tabular}{clccccc}
    ...
    \multirow{3}{*}{1024}                
                    ...
                    &Agg. Sig. size   & 682 KB      & 572 KB    & 120 KB    & 5.7$\times$ & 4.8$\times$ \\\midrule
    \multirow{3}{*}{8192}                
                    &Aggregation      & -           & 9.6 sec   & 4.6 sec   &     -       & 2.1$\times$ \\%\cline{2-7}
                    &Batch Verification    
                                      & 294 ms      & 53  ms    &  45 ms    & 6.5$\times$ & 1.2$\times$ \\%\cline{2-7}
                    &Agg. Sig. size   & 5.5 MB      & 762 KB    & 135 KB    & 41 $\times$ & 5.6$\times$\\ \bottomrule
  \end{tabular}
...
\begin{table}[t]\centering
  \begin{tabular}{ccccccc}
      ...
      \multirow{2}{*}{21} & \multirow{2}{*}{9.1 sec}  & \multirow{2}{*}{0.40 ms}  & 1024    &   468 ms     &  8.6 ms       & 120 KB     \\%\cline{4-7}
                          &                           &                           & 8192    &   3.8 sec    &  42.6 ms      & 135 KB     \\\hline

      \multirow{2}{*}{23} & \multirow{2}{*}{37.4 sec} & \multirow{2}{*}{0.44 ms}  & 1024    &   516 ms     &  8.9 ms       & 135 KB     \\%\cline{4-7}
                          &                           &                           & 8192    &   4.1 sec    &  46 ms        & 152 KB     \\\hline

      \multirow{2}{*}{26} & \multirow{2}{*}{  4 min}  & \multirow{2}{*}{0.44 ms}  & 1024    &   630 ms     &  9.4 ms       & 145 KB     \\%\cline{4-7}
                          &                           &                           & 8192    &   4.6 sec    &  51 ms        & 163 KB     \\\bottomrule
...
An aggregated signature of size $120$ Kilobytes, consists of the following components.
The aggregated path and its adjacent nodes belonging to the homomorphic vector commitment, i.e. $\tau(2\limbs-1)$ polynomials in $\ring$ with an infinity norm bound $\bagg <2^{15}$, which constitute around $100.8$ kilobytes.
The aggregated decomposed public keys for the one time signature scheme, i.e., $2\limbs'-1$ polynomials in $\ring$ with norm bound $\bagg < 2^{15}$ that constitutes around $6.7$ kilobytes.
The aggregated one time signature, i.e., $\otspkkeylen$ polynomials in $\ring$ with norm bound $\beta_\sigma < 2^{20}$, that constitutes $12.8$ kilobytes. %\gnote{@Zhenfei/Mark:Grammar}
This fits inside a single ethereum block whose peak size is around 130 Kilobytes\footnote{\url{https://etherscan.io/chart/blocksize}}.
