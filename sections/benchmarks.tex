...
Note that with encoding, although the verification algorithm becomes serial across different layers of the tree, within each layer, the computation is still parallelization friendly, 
in terms of both the hash functions and the ring multiplications.
