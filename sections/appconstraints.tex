...
We used a script\footnote{\label{fn:github}\url{https://github.com/GottfriedHerold/Chipmunk}} find concrete parameters that allow for instantiating Chipmunk based on a hard ring-SIS problem.
