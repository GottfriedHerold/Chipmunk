...
This point of view lets us use Babai's algorithm proper rather than the more naive Babai rounding: here, we (greedily) choose coefficients w.r.t.\ a given basis $\kernelbasis$, but differently to Babai rounding, we choose coefficients one-by-one and
