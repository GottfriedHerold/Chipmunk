...
Let $q,\eta$ be positive integers with $q$ prime. Set $\limbs \coloneqq \ceiled{ \log_{2\eta+1}q}$ and define lattices
\begin{align*}
...
\begin{figure}[ht]
 \begin{pchstack}[center,boxed]
   ...
   \text{Obtain $\eta, q, \limbs$ from $\params$ with $\limbs = \ceiled{\log_{2\eta+1}q}$}\\
 ...
 \caption{%
    ...
    We assume that the public parameters $\params$ define $q, \eta, \limbs = \ceiled{\log_{2\eta+1}q}$.
...
Let $q,\eta,\limbs$ be positive integers with $q$ prime and $\limbs = \ceiled{\log_{2\eta+1}q}$. Let $\params$ be some public parameters determining those integers.
...
$\modopening = (\ring^\limbs)^{2\tau} \times (\ring^{\limbs'})^\xi$, where $\limbs = \ceiled{\log_{2\eta+1}q}$, $\limbs' = \ceiled{\log_{2\eta+1}q'}$.
...
\begin{pchstack}[center,boxed]
 ...
 \caption{%
    ...
    We assume that the public parameters $\params$ determine $q, \eta, \limbs = \ceiled{\log_{2\eta+1}q}$.
%     The vectors $\vec{b}_1,\ldots, \vec{b}_{\limbs-1}$ are the basis of $\latring$ as defined in \autoref{prop:kernellattices}.
    }
...
\begin{table}\centering
 \begin{tabular}{ccc@{\hskip 3.5ex}l}
  ...
  \hline
  \multirow{4}{*}{opening}& \multirow{2}{*}{without encoding} &individually verifying & $\bigl(2\tau\limbs + \xi\limbs'\bigr)n\cdot \ceiled{\log(2\eta+1)}$\\\cline{3-4}
                          &                                   &strongly verifying & $\bigl(2\tau\limbs + \xi\limbs'\bigr)n\cdot \ceiled{\log(2\bagg+1)}$  \\\cline{2-4}
                          & \multirow{2}{*}{with encoding}    &individually verifying & $\bigl(\tau\limbs + \xi\limbs'\bigr)n\cdot \ceiled{\log(2\eta+1)}$\\\cline{3-4}
                          &                                   &strongly verifying & $\bigl(\tau\limbs + \xi\limbs'\bigr)n\cdot \ceiled{\log(2\eta+1)}+ \tau\limbs n\ceiled{\log (\frac{\bagg}{\eta}+\frac12)}$\\
                          \hline
 \end{tabular}
 \caption{bitlength of our HVC constructions. We denote by $\limbs = \ceiled{\log_{2\eta+1}q}$ and $\limbs' = \ceiled{\log_{2\eta+1}q'}$ the number of limbs for the decompositions of $\ring_q$ resp.\ $\ring_{q'}$ elements.}
